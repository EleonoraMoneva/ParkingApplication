...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String DB_PATH = "/data/user/0/com.example.parkapplication/databases/";
    ...
    public boolean addNewUser (com.example.parkapplication.CustomerModel customerModel){
