...
public class MyAdapter extends RecyclerView.Adapter<com.example.parkapplication.MyAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent (context, com.example.parkapplication.ReservationForm.class);
