...
public class ReservationForm extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(com.example.parkapplication.ReservationForm.this);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        com.example.parkapplication.ReservationForm.this,
        ...
        reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(com.example.parkapplication.ReservationForm.this, com.example.parkapplication.ParkingPlaces.class);
