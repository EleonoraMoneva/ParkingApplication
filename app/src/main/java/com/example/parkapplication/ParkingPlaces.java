...
public class ParkingPlaces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.parkapplication.MyParkingAdapter adapterce = new com.example.parkapplication.MyParkingAdapter(this, name, parking_lots_names, num_parking_spots, num_reserved_spots, date, time_slot, userName);
